...
def show_menu(surface):
    ...
    TextSurf, TextRect = text_objects("Load saved game", menu_text_font)
    TextRect.center = (400, 150)
    surface.blit(TextSurf, TextRect)
    TextSurf, TextRect = text_objects("Save game", menu_text_font)
    TextRect.center = (400, 250)
    surface.blit(TextSurf, TextRect)
    TextSurf, TextRect = text_objects("Quit the game", menu_text_font)
